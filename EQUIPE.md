...
- Módulo financeiro (ROI, ponto de equilíbrio)
...
### Arquivos Criados
- **Total:** 47 arquivos essenciais
- **Módulos Python:** 8 arquivos
- **Módulos JavaScript:** 15 arquivos
...
- **Hospedagem Código:** GitHub
- **Database:** Firebase/Firestore + localStorage

### Fluxo de Trabalho
1. **Planejamento:** Definição de requisitos e arquitetura
2. **Desenvolvimento:** Implementação em branches/features
3. **Testes:** Validação individual e em grupo
4. **Revisão:** Code review entre membros
5. **Deploy:** Push para GitHub → Deploy automático Netlify
...
- **Cristiano Silva Santos:** Cristiano.s.santos@ba.estudante.senai.br

### Para Contribuições
- **GitHub:** https://github.com/cristiano-superacao/projetowash
- **Issues:** Abra uma issue no repositório

### Para Informações Acadêmicas
- **Professor:** Washington Luis Souza Anunciação
- **Instituição:** SENAI
...
- **Colegas de Turma** - Apoio e colaboração
